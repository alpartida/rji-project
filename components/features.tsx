...
import FeaturesImage from "/public/images/article_tools_for_articlepage.jpg";
        ...
        <div className="border-t py-12 [border-image:linear-gradient(to_right,transparent,theme(colors.slate.400/.25),transparent)1] md:py-20">
          ...
          <div className="mx-auto max-w-3xl pb-4 text-center md:pb-12">
            ...
            <p className="text-lg text-indigo-200/65">
              Explore essential tools and strategies to enhance your article
              page design. From audience engagement to performance tracking,
              these features provide a comprehensive approach to creating a
              seamless, accessible, and impactful reader experience.
            </p>
          </div>
          ...
          <div className="mx-auto grid max-w-sm gap-12 sm:max-w-none sm:grid-cols-2 md:gap-x-14 md:gap-y-16 lg:grid-cols-3">
            <article>
              ...
              <p className="text-indigo-200/65">
                Implement techniques to captivate readers, fostering loyalty and
                encouraging interaction with your content.
              </p>
            </article>
            <article>
              <svg
              ...
              <p className="text-indigo-200/65">
                Enhance user experience with intuitive navigation and optimized
                search, helping readers quickly find what they need.
              </p>
            </article>
            <article>
              <svg
              ...
              <p className="text-indigo-200/65">
                Incorporate accessibility standards to make your article pages
            ...
            <article>
              ...
              <p className="text-indigo-200/65">
                ...
                visibility, drawing more readers to your content organically.
              </p>
            </article>
          </div>
        </div>
