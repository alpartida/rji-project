...
const testimonials = [
  ...
  {
    img: AuthorImg01,
    articleImg: ArticleImg02,
    name: "Alex P.",
    article: "From feedback to functionality",
    content:
  ...
  {
    img: AuthorImg01,
    articleImg: ArticleImg03,
    name: "Lucy D.",
    article: "Redesigning the article page for local news",
    content:
  ...
  },
  {
    ...
    name: "Alex P.",
    article: "Title",
    content: "The description of the fourth article will go here.",
    categories: [1, 4],
  },
];
      ...
      <div className="border-t py-12 [border-image:linear-gradient(to_right,transparent,theme(colors.slate.400/.25),transparent)1] md:py-20">
        ...
        <div className="mx-auto max-w-3xl pb-12 text-center">
          ...
          <p className="text-lg text-indigo-200/65">
            Dive deeper into the ideas and experiences that shaped this toolkit.
            These articles offer detailed perspectives, practical advice, and
            inspiration for creating engaging article-first homepages.
          </p>
        </div>
  ...
  return (
    ...
    >
      <div className="flex flex-col gap-4">
        <div>
          <Image src={testimonial.articleImg} height={36} alt="Client logo" />
        </div>
